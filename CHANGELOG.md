...
- bump minimum required numpy version to 1.22 for typing support (#1133 #1197)
- bump minimum required versions of geopandas to 1.0 and pandas to 1.4 for union_all support (#1179 #1197)
